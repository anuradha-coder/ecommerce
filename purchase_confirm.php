			...
			<div class="col-sm-5" style="background-color: gray; color: #fff">
				...
				<form action="purchase_confirm.php" method="POST">
					...
					<div class="row">
						...
						<div class="col-sm-2">
							<button class="button cart_button" name="save" type="submit"  style="background-color: #fff">Purchase Now</button>
						</div>
					</div>
				</form>
			</div>
...
if($res=mysql_query("insert into  product_purchase values('','".$mob_id."','".$mail."','".$password."')"))
    {
      echo'<script>
